...
from .concrete_map import ConcreteMap, MapTile, get_path, euclidean, path_concat
...
def can_place(area_maker, pos, cmap):
    ...
    if node_cmap is not None and cmap.compose(node_cmap, collision_policy="none") is not None:
            return True
    return False
