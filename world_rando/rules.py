...
item_to_image = {
    ItemSet(["MB"]): "item_morph_outline.png",
    ItemSet(["M"]): "item_missile_outline.png",
    ItemSet(["B"]): "item_bombs_outline.png",
    ItemSet(["PB"]): "item_power_bomb_outline.png",
    ItemSet(["SPB"]): "item_springball_outline.png",
    ItemSet(["S"]): "item_super_outline.png",
    ItemSet(["G"]): "item_grapple_outline.png",
    ItemSet(["SA"]): "item_screw_outline.png",
    ItemSet(["V"]): "item_varia_outline.png",
    ItemSet(["GS"]): "item_gravity_outline.png",
    ItemSet(["SB"]): "item_speed_outline.png",
    ItemSet(["HJ"]): "item_hi_jump_outline.png",
    ItemSet(["CB"]): "item_charge_outline.png",
    ItemSet(["WB"]): "item_wave_outline.png",
    ItemSet(["WB"]): "item_wave_outline.png",
    ItemSet(["E"]): "item_energy_outline.png",
    ItemSet(["PLB"]): "item_plasma_outline.png",
    ItemSet(["Spazer"]): "item_spazer_outline.png",
    ItemSet(["RT"]): "item_reserve_outline.png",
    ItemSet(["XR"]): "item_xray_outline.png",
    ItemSet(["IB"]): "item_ice_outline.png",
